...
function OnFullScreenAnythingModeChangeClick (element)
{
	switch(TC.state) {
		case 'notInitialized':
			initializeTabCinema();
...
function initializeTabCinema() { TC = {
	...
	minimizeVideo: function() {
		...
		window.scrollY = this.scrollBeforeMaximize.top
		window.scrollX = this.scrollBeforeMaximize.left;
